...
<img src="./client/src/assets/image_gallery.gif" alt="Gif of the image gallery navigation in the overview widget">
<img src="./client/src/assets/style_selector.gif" alt="Gif of the style selector in the overview widget">
